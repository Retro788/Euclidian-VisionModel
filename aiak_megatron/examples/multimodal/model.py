...
from megatron.core.models.multimodal.mini_retro_model import IMAGE_TOKEN, MiniRetroModel
...
def model_provider(
    ...
    assert args.encoder_pipeline_model_parallel_size <= 1, \
        "MiniRetro does not support pp>1 for encoder on it's own pipeline rank"
