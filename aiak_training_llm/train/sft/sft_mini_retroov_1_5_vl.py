...
@register_model_trainer(model_family=[constants.VisionLanguageModelFamilies.MINI_RETRO_OV_1_5],
                        training_phase=constants.TrainingPhase.SFT)
def default_pretrain_trainer(train_args):
    """build trainer"""
    from aiak_training_llm.train.pretrain import pretrain_mini_retroov_1_5
    ...
    trainer = MegatronTrainer(
        ...
        train_valid_test_dataset_provider=pretrain_mini_retroov_1_5.train_valid_test_dataset_provider,
        model_provider=pretrain_mini_retroov_1_5.model_provider,
        model_type=model_type,
        forward_step_func=pretrain_mini_retroov_1_5.forward_step,
    )
