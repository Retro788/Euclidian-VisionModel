...
class MiniRetroModel(MegatronModule):
    """MiniRetro multi-modal model.
    ...
    def __init__(
        ...
        log_single_rank(
            ...
            logging.WARNING,
            "MiniRetro is work in progress. Features are missing and methods can change.",
        )
        ...
        if self.sequence_parallel_lm or self.context_parallel_lm > 1:
            ...
            if self.context_parallel_lm > 1:
                assert is_te_min_version(
                    "1.10.0"
                ), "Context Parallelism in MiniRetro requires TE v1.10 or higher"
    ...
    def _preprocess_data(
        ...
        models/mini_retro_next/modeling_mini_retro_next.py#L409
    ...
    def forward(
        ...
        """Forward function of the MiniRetro model.
