...
- Enable pipeline parallelism for T5 & MiniRetro models
- Support multi-tile multi-image input in MiniRetro models
- MoE
  - FP8 support
...
- Multimodal
  - Added initial support for training vision language models using the MiniRetro architecture
