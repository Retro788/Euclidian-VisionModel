...
GBS="${5:-16}"
NSTEP="${6:-20000}"
DATA_PATH=${DATA_PATH:-"/workspace/dataset/MiniRetro-OneVision-1.5-Mid-Training-Quick-Start-3M-Webdataset"}
TOKENIZER_PATH=${TOKENIZER_PATH:-"/workspace/MiniRetro-OneVision-1.5/MiniRetro-OneVision-1.5-4B-stage0"}
CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/workspace/MiniRetro-OneVision-1.5/stage_1_alignment_mini_retro_ov_4b_release"}
...
MODEL_ARGS=(
    --model-name mini-retro-ov-1.5-4b
)
