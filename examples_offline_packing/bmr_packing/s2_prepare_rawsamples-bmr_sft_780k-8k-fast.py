...
# python -u s2_prepare_rawsamples-mini-retro_vqa.py 2>&1 | tee s2_proc_mini_retro.log
...
SRC_DIR_IMGS = "/data_1/mini_retro_next_raw_full/split_json_files"   # 原始 img  数据的存放位置
SRC_DIR_JSONS = "/data_1/mini_retro_next_raw_full/split_json_files"   # 原始 json 数据的存放位置
