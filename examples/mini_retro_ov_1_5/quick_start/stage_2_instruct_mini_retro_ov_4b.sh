...
GBS="${5:-224}"
NSTEP="${6:-3500}"
DATA_PATH=${DATA_PATH:-"/workspace/dataset/MiniRetro-NeXT-780k-webdataset"}
TOKENIZER_PATH=${TOKENIZER_PATH:-"/workspace/MiniRetro-OneVision-1.5/MiniRetro-OneVision-1.5-4B-stage0"}
CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/workspace/MiniRetro-OneVision-1.5/stage_1.5_mid_training_mini_retro_ov_4b_release"}
