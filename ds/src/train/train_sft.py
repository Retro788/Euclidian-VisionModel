...
from mini_retroonevision1_5.modeling_mini_retroonevision1_5.py import MiniRetroOneVision1_5_ForConditionalGeneration
...
def train():
    ...
    try:
        if "Qwen2.5" in model_args.model_id:
            ...
            rank0_print("Loading MiniRetroOneVision model...")
            model = MiniRetroOneVision1_5_ForConditionalGeneration.from_pretrained(
                model_args.model_id,
                torch_dtype=compute_dtype,
                attn_implementation="flash_attention_2" if not training_args.disable_flash_attn2 else "sdpa", 
                **bnb_model_from_pretrained_args
