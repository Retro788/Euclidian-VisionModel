...
python s1_get_tokenlens_v2-sft.py --config ./configs/s1_config_mini_retro_vqa.yaml
python s1_get_tokenlens_v2-sft.py --config ./configs/s1_config_mini_retro_vqa_600k.yaml
