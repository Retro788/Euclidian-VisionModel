...
from .data_utils import get_image_info, get_video_info, mini_retro_to_openai, pad_sequence
import random
...
class SupervisedDataset(Dataset):
    ...
    def _get_item(self, i):
        ...
        sources = copy.deepcopy(mini_retro_to_openai(sources['conversations'], is_video=is_video))
