...
GBS="${5:-8}"
NSTEP="${6:-2500}"
DATA_PATH=${DATA_PATH:-"/workspace/dataset/MiniRetro-558K-Webdataset"}
TOKENIZER_PATH=${TOKENIZER_PATH:-"/workspace/MiniRetro-OneVision-1.5/MiniRetro-OneVision-1.5-4B-stage0"}
CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/workspace/MiniRetro-OneVision-1.5/MiniRetro-OneVision-1.5-4B-stage0_mcore_tp1_pp1"}
